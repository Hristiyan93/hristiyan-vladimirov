<div class="page-title-container">
    <div class="container">
        ...
        <ul class="breadcrumbs pull-right">
            ...
            <li class="active"><?php echo $this->translate('Signup Complete')?></li>
        </ul>
    </div>
</div>
        ...
        <div class="row">
            <div id="main" class="col-sm-8 col-md-9">
                <div class="booking-information travelo-box">
                    <h2><?php echo $this->translate('Email confirmation')?></h2>
                    <hr />
                    <div class="booking-confirmation clearfix">
                        <i class="soap-icon-recommend icon circle"></i>
                        <div class="message">
                            <h4 class="main-message"><?php echo $this->translate('Thank You. Email confirmation sent.')?></h4>
