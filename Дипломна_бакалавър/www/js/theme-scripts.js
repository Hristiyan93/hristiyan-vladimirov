...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="home" href="index.html"><img alt="" src="images/logo.png"></a></h1>').insertBefore('.chaser .menu');
    ...
    tjq("body").on("click", ".soap-popupbox", function(e) {
        ...
        tjq(sourceId).find('.alert-error').hide();
        tjq(sourceId).show();
